...
import plugin from '../src/property-strict-value.js';
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.expected('outline-color'),
		},
		{
		...
		},
		{
			...
			message: messages.expected('outline'),
		},
		{
		...
		},
		{
			...
			message: messages.expected('margin-left'),
		},
		{
		...
		},
		{
			...
			message: messages.expected('grid-gap'),
		},
		{
			code: 'div {font: test}',
		...
		},
		{
			...
			message: messages.expected('text-transform'),
		},
	],
});
